...
import { Create, FormTab, TabbedForm, TextInput, required, SaveButton, Toolbar, useGetList, Edit } from 'react-admin';
...
export default DestructionEdit;
